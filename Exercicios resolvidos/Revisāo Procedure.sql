/*1)	CRIE O BD “fabrica”
2)	CRIE AS TABELAS, CADA OS CAMPOS CONFORME O DER, com a restrição em cor de moto para preto, vermelho e prata e para cilindradas para 125, 150, 250 e 300.
3)	FAÇA 2 INSERTS EM CADA TABELA
4)	Faça um SELECT INNER JOIN para mostrar as motos vermelhas de 250cc
5)	CRIE PROCEDURES INSERT/UPDATE PARA AS TABELAS (2 PROCEDURES)
6)	CRIE PROCEDURES SELECT PERMITINDO SELECIONAR POR ID OU GERAL (EXEMPLO COM IFs) PARA AS TABELAS (2)
7)	CRIE PROCEDURES DELETE PARA AS TABELAS (2)
*/
